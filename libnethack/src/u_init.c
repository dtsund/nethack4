...
static const struct def_skill Skill_Mon[] = {
    ...
    {P_SHURIKEN, P_EXPERT},
    {P_ATTACK_SPELL, P_BASIC}, {P_DEFENSE_SPELL, P_EXPERT},
...
static const struct def_skill Skill_P[] = {
    ...
    {P_DEFENSE_SPELL, P_EXPERT}, {P_DIVINATION_SPELL, P_EXPERT},
    {P_MATTER_SPELL, P_SKILLED},
    {P_BARE_HANDED_COMBAT, P_BASIC},
    {P_NONE, 0}
};
...
static const struct def_skill Skill_R[] = {
    ...
    {P_ENCHANTMENT_SPELL, P_SKILLED}, {P_ESCAPE_SPELL, P_EXPERT},
...
static const struct def_skill Skill_V[] = {
    ...
    {P_LANCE, P_EXPERT}, {P_SLING, P_BASIC},
...
static const struct def_skill Skill_W[] = {
    ...
    {P_DART, P_BASIC}, {P_SHURIKEN, P_BASIC},
    {P_ATTACK_SPELL, P_EXPERT}, {P_DEFENSE_SPELL, P_EXPERT},
