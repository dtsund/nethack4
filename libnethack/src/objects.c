...
#define SPELL(name,desc,sub,prob,delay,level,mgc,dir,color) OBJECT( \
    ...
    SPELL("cone of cold", "dog eared", P_ATTACK_SPELL, 15, 7, 4, 1, RAY,
          HI_PAPER),
    SPELL("sleep", "mottled", P_ENCHANTMENT_SPELL, 55, 1, 1, 1, RAY, HI_PAPER),
    ...
    SPELL("detect monsters", "leather-bound", P_DIVINATION_SPELL, 43, 1, 1, 1,
          NODIR, HI_LEATHER),
    SPELL("healing", "white", P_HEALING_SPELL, 45, 2, 1, 1, IMMEDIATE,
          CLR_WHITE),
    SPELL("knock", "pink", P_MATTER_SPELL, 40, 1, 1, 1, IMMEDIATE,
          CLR_BRIGHT_MAGENTA),
    ...
    SPELL("drain life", "velvet", P_ATTACK_SPELL, 10, 2, 2, 1, IMMEDIATE,
          CLR_MAGENTA),
    SPELL("slow monster", "light green", P_ENCHANTMENT_SPELL, 35, 2, 2, 1,
          IMMEDIATE, CLR_BRIGHT_GREEN),
    SPELL("wizard lock", "dark green", P_MATTER_SPELL, 35, 3, 2, 1, IMMEDIATE,
          CLR_GREEN),
    SPELL("create monster", "turquoise", P_CLERIC_SPELL, 40, 3, 2, 1, NODIR,
          CLR_BRIGHT_CYAN),
    ...
    SPELL("clairvoyance", "dark blue", P_DIVINATION_SPELL, 15, 3, 3, 1, NODIR,
          CLR_BLUE),
    SPELL("cure sickness", "indigo", P_HEALING_SPELL, 37, 3, 3, 1, NODIR,
          CLR_BLUE),
    ...
    SPELL("detect treasure", "gray", P_DIVINATION_SPELL, 20, 5, 4, 1, NODIR,
          CLR_GRAY),
    SPELL("remove curse", "wrinkled", P_CLERIC_SPELL, 30, 5, 3, 1, NODIR,
          HI_PAPER),
